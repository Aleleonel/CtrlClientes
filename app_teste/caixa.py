...
class CaixaForm(QDialog):
    ...
    def createLayout(self):
        ...
        grid.addWidget(lineEdit_username)
        ...
        hboxlayout.addWidget(button_efetiva)
        ...
        hboxlayout.addWidget(button_imprime)
        ...
        hboxlayout.addWidget(button_cancela)
